...
|---|---|---|
| [Agent Dreaming & Memory Guide](./agent-dreaming-guide.md) | Out-of-band memory consolidation ("dreaming") to improve agent learning, context, multi-agent operation, and the memory system — with key takeaways and an implementation matrix. | active |
